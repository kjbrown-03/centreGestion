    ...
    <footer id="contact" className="bg-[color:var(--navy)] text-white pt-24 pb-10">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="mt-4 text-white/65 max-w-sm">
              Le Centre de Santé 2KC, pour une médecine moderne, humaine et accessible à tous.
            </p>
          </div>
          <div className="space-y-3 text-white/80">
            <div className="flex items-start gap-3"><MapPin className="size-4 mt-0.5 text-[color:var(--mint)]" /> 12 avenue de la République, Centre médical 2KC</div>
            <div className="flex items-center gap-3"><Phone className="size-4 text-[color:var(--mint)]" /> +33 1 23 45 67 89</div>
            <div className="flex items-center gap-3"><Mail className="size-4 text-[color:var(--mint)]" /> contact@2kc-sante.fr</div>
          </div>
          <div>
        ...
        <div className="mt-16 border-t border-white/10 pt-6 text-center text-xs text-white/40">
          © {new Date().getFullYear()} Centre de Santé 2KC. Tous droits réservés.
        </div>
      </div>
    </footer>
  );
