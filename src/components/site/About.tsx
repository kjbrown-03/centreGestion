  ...
  return (
    <section id="about" className="py-32 bg-muted/40">
      <div className="mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-16 items-center">
        <Reveal>
          <div className="relative">
            ...
            <img
              ...
              alt="Équipe médicale 2KC en consultation"
            ...
            <div className="absolute -bottom-6 -right-6 glass rounded-2xl p-5 shadow-glow hidden sm:block">
              ...
              <p className="text-xs text-muted-foreground uppercase tracking-wider">d'excellence médicale</p>
            </div>
          </div>
        </Reveal>
        ...
        <Reveal delay={0.1}>
          <div>
            <p className="text-sm font-semibold uppercase tracking-widest text-[color:var(--mint)]">À propos de 2KC</p>
