...
export const homeText = {
  fr: {
    ...
    login: "Connexion",
    signup: "S'inscrire",
    badge: "Centre de Sante 2KC - Agree & certifie",
    h1a: "Soigner.",
    h1b: "Accompagner.",
    h1c: "Reinventer.",
    heroCopy: "Une medecine humaine et precise, augmentee par une plateforme moderne. Vos equipes et vos patients, au meme endroit.",
    cta: "Acceder a mon espace",
    discover: "Decouvrir le centre",
    patients: "+12 000 patients suivis",
    care: "Soins & Prevention",
    open: "Ouvert 7j/7",
    welcome: "Bienvenue a notre application de gestion de centre de sante.",
  },
  en: {
    navServices: "Services",
    navAbout: "About",
